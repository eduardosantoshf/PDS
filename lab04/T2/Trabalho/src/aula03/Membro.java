...
public class Membro{
	...
	public static Membro getInstance(String n, String l) {
		...
		if(x1<0) {
			System.out.println("Primeiro valor de localização inválido");
			return m;
		}
		if(x1>x2) {
			System.out.println("Primeiro valor de localização maior que o segundo");
			return m;
		}
		if(!(Character.isAlphabetic(n.charAt(0)))) {
			System.out.println("Primeiro carater não é uma letra");
			return m;
		}
